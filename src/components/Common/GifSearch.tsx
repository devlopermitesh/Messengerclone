...
return (
   ...
   <div className=" absolute bottom-15 flex justify-center items-center w-80 h-100 py-4 px-6 rounded-lg flex-col space-y-2 overlfow-x-hidden p-2 shadow-md bg-slate-50">
